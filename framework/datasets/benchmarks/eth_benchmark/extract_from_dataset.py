...
def seq_collate(batch):
    ...
    for idx, sample in enumerate(batch):
        ...
        (peds_num, pre_motion_3D, fut_motion_3D, source) = sample
...
class TrajDataset(Dataset):
    ...
    def __init__(self, dir, obs_len=8, pred_len=12, set_name='eth', typ='train'):
        ...
        self.sourceSeqs_in_scene = self.raw_data[3] 
    ...
    def __getitem__(self, index):
        ...
        out = [torch.Tensor([peds_num]), pre_motion_3D, fut_motion_3D, source]
        return out
...
if __name__ == "__main__":
    ...
    for set_name in set_names:
        ...
        for split in splits:
            ...
            for id, src in enumerate(sources_flat):
                
                if src == 'univ_samples':
                    sources_flat[id] = 'univ'
