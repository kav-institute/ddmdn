...
def data_preprocess(data_dir, data_file, obs_len=8, pred_len=12, skip=1):
    ...
    with open(data_file, "wb") as f:
        pickle.dump((seq_list, num_peds_in_seq, num_seqs_in_scene, source_list), f)
...
desired_source = ['eth', 'hotel', 'univ', 'zara01', 'zara02']
...
for dataset_name in desired_source:
    ...
    for split in data_class:
        ...
        data_dir = os.path.join('/workspace/data/benchmarks', dataset_name, 'raw', split)
        data_out_file = os.path.join('/workspace/data/benchmarks', dataset_name, 'pkl', dataset_name + '_' + split + '.pkl')
        
        if not os.path.exists(os.path.join('/workspace/data/benchmarks', dataset_name, 'pkl')):
            os.makedirs(os.path.join('/workspace/data/benchmarks', dataset_name, 'pkl'))
