...
data_generator = Sample_Generator(path=path, dataset='ind', typ='train', obs_len=8, future_len=12, sample_rate=0.4, norm=False, augment=True, num_workers=16)
data_generator = Sample_Generator(path=path, dataset='ind', typ='test', obs_len=8, future_len=12, sample_rate=0.4, norm=False, augment=False, num_workers=16)
